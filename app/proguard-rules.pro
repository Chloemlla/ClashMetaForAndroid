...
# Source: Project-Lumen/lumen-crash/README.md + host-proguard-template.pro
############################################################

-keepattributes *Annotation*, InnerClasses, EnclosingMethod, Signature, RuntimeVisibleAnnotations

# Required: author attribution + integrity checks (fail-closed)
...
# Required public SDK API used by host integration
