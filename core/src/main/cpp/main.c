...
static int call_dns_interface_received_impl(void *callback, const char *payload) {
    TRACE_METHOD();
    ...
    jboolean accepted = (*env)->CallBooleanMethod(env,
                                                  (jobject) callback,
                                                  (jmethodID) m_dns_interface_received,
                                                  (jstring) new_string(payload));
...
static int call_http_interface_received_impl(void *callback, const char *payload) {
    ...
    jboolean accepted = (*env)->CallBooleanMethod(env,
                                                  (jobject) callback,
                                                  (jmethodID) m_http_interface_received,
                                                  (jstring) new_string(payload));
...
JNIEXPORT jlong JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeSubscribeDns(JNIEnv *env, jobject thiz,
                                                                    jobject callback) {
    TRACE_METHOD();

    jobject _callback = new_global(callback);

    return (jlong) subscribeDns(_callback);
}

JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeUnsubscribeDns(JNIEnv *env, jobject thiz,
                                                                      jlong token) {
    TRACE_METHOD();
...
JNIEXPORT jlong JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeSubscribeHttp(JNIEnv *env, jobject thiz,
                                                                     jobject callback) {
    TRACE_METHOD();

    jobject _callback = new_global(callback);

    return (jlong) subscribeHttp(_callback);
}

JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeUnsubscribeHttp(JNIEnv *env, jobject thiz,
                                                                       jlong token) {
    TRACE_METHOD();

    unsubscribeHttp((int64_t) token);
}
